...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="./images/${product_info.prodImage}" alt="..." /></div>
            <div class="col-md-6">
                <div class="small mb-1">${product_info.prdCode}</div>
                <h1 class="display-5 fw-bolder">${product_info.prdName}</h1>
                <div class="fs-5 mb-5">
                    <span class="text-decoration-line-through">${product_info.originPrice}원</span>
                    <span>${product_info.salePrice}원</span>
                </div>
        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <!-- Product image-->
                    <img class="card-img-top" src="./images/과테말라 안티구아.jpg" alt="..." />
                    <!-- Product details-->
